...
api.prototype.getInputs = function(options, callback) {
    ...
    var address = this.getAddress(this.keypath, false);
...
api.prototype.prepareTransfers = function(transfers, options, callback) {
    ...
    if (totalValue) {
        ...
        //  confirm that the inputs exceed the threshold
            ...
            self.getInputs({ 'threshold': totalValue, 'security': security }, function(error, inputs) {
    ...
    function signInputsAndReturn(inputs) {
        ...
        for (var i = 0; i < bundle.bundle.length; i++) {
            ...
            if (bundle.bundle[i].value < 0) {
                ...
                var key = self._readKey(self.keypath);
